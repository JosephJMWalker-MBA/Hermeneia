...
When one model is asked to attend, discover, interpret, communicate, evaluate, and govern simultaneously — reasoning becomes difficult to inspect, failures become difficult to diagnose, and conclusions become difficult to trust. More fundamentally: the record of how understanding *developed* is lost entirely.

Hermeneia preserves that record by separating the responsibilities.
...
These are not software modules. They are cognitive responsibilities — ordered by their position in the development of understanding.

A candidate role under active investigation: **Witness** — records human attention before interpretation begins (Marginalia interface, Authorship Deed). Awaiting practice before earning canonical status.
