...
def test_evidence_board_selection_is_transient_and_sets_exact_scope_ids() -> None:
    result = _run_node(
        _base_script(
            """
            _evidenceBoardData = {
              counts: {highlights: 2, field_notes: 0, observations: 0, questions: 0, theme_buckets: 1, evidence_buckets: 1, uncategorized_highlights: 0},
    ...
    assert "2 Reader highlights" in result["chip"]
